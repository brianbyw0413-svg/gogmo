      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0c0a09]/80 backdrop-blur-sm border-b border-[#292524]">
        <div className="max-w-7xl mx-auto px-3 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <a href="https://auth.line.me/oauth/authorize?response_type=code&client_id=2009340718&redirect_uri=https%3A%2F%2Fgmo.zeabur.app%2Fdriver%2Fline-callback&state=driver&bot_prompt=normal" className="px-3 py-1.5 bg-[#d4af37] text-[#0c0a09] rounded font-bold">司機登入</a>
            <a href="https://auth.line.me/oauth/authorize?response_type=code&client_id=2009277112&redirect_uri=https%3A%2F%2Fgmo.zeabur.app%2Fdriver%2Fline-callback&state=dispatcher&bot_prompt=normal" className="px-3 py-1.5 bg-[#d4af37] text-[#0c0a09] rounded font-bold">調度登入</a>
