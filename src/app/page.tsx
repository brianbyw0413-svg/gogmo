      ...
      <main className="pt-16 pb-8">
        <div className="max-w-6xl mx-auto px-2">
          ...
          <div className="flex flex-col items-center gap-4">
            <a href="https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=2009340718&redirect_uri=https%3A%2F%2Fgmo.zeabur.app%2Fdriver%2Fline-callback&state=driver_register&scope=profile%20openid&bot_prompt=normal" className="block w-56 px-5 py-2.5 bg-gradient-to-r from-[#d4af37] to-[#e8c44a] text-[#0c0a09] rounded-lg font-bold text-center text-sm shadow-[0_0_15px_rgba(212,175,55,0.3)] hover:shadow-[0_0_25px_rgba(212,175,55,0.5)] transition-all">
              司機註冊
            </a>
            <a href="https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=2009340718&redirect_uri=https%3A%2F%2Fgmo.zeabur.app%2Fdriver%2Fline-callback&state=dispatcher_register&scope=profile%20openid&bot_prompt=normal" className="block w-56 px-5 py-2.5 bg-gradient-to-r from-[#d4af37] to-[#e8c44a] text-[#0c0a09] rounded-lg font-bold text-center text-sm shadow-[0_0_15px_rgba(212,175,55,0.3)] hover:shadow-[0_0_25px_rgba(212,175,55,0.5)] transition-all">
              調度員註冊
            </a>
          </div>
        </div>
